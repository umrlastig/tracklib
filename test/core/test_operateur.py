...
class TestOperateurMethods(unittest.TestCase):
    ...
    def test_abs_curv1(self):
        ...
        track = TrackReader.readFromCsvFiles(chemin, 2, 3, -1, 4, separator=",", DateIni=-1, h=0, com="#", no_data_value=-999999, srid="ENUCoords")
    ...
    def test_import(self):
        ...
        track1 = TrackReader.readFromCsvFiles(path, "RTKLIB")            # Lecture du fichier
        ...
        track3 = TrackReader.readFromCsvFiles(path, "IMU_STEREOPOLIS")   # Lecture du fichier
