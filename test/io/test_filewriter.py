...
class TestFileWriter(TestCase):
    ...
    def test_write_csv_2AF(self):
        ...
        txt += "0.000;0.000;0.000;01/01/2020 10:00:00;1.0;0\n"
        txt += "0.000;1.000;0.000;01/01/2020 10:00:01;0.7071067811865476;1.0\n"
        txt += "1.000;1.000;0.000;01/01/2020 10:00:02;0.7071067811865476;2.0\n"
        txt += "1.000;2.000;0.000;01/01/2020 10:00:03;0.7071067811865476;3.0\n"
        txt += "2.000;2.000;0.000;01/01/2020 10:00:04;1.0;4.0\n"
        self.assertEqual(contents.strip(), txt.strip())
